...
## Palette Healthcare/Trust (exemple)

Pour les projets santé/mutuelle/healthcare, ces palettes transmettent confiance et bienveillance :

```
Trustworthy & Caring:
- Primary: #2563EB (bleu confiance — actions, CTA)
- Deep: #1E3A5F (backgrounds, navigation, profondeur)
- Calming: #059669 (vert apaisant — validations, santé)
- Light: #F8FAFC (blanc cassé — backgrounds)
- Muted: #64748B (textes secondaires)
- Warm accent: #F59E0B (alertes, badges)

Alternative — Soft Clinical:
- Primary: #3B82F6 (bleu clair, accessible, médical)
- Accent: #10B981 (vert émeraude, vitalité)
- Background: #F0F9FF (bleu pâle, calme)
- Text: #1E293B (gris très foncé, lisible)
```
...
| **Healthcare/Trust** | **Libre Baskerville, Source Serif 4, Merriweather** | **Plus Jakarta Sans, Source Sans 3, Nunito** |
...
| **Healthcare, trustworthy** | **Humanist serif (Source Serif 4), soft blues/greens, generous spacing, calming motion** |
